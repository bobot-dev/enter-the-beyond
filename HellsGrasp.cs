    ...
    class HellsGrasp : PassiveItem
    {
        ...
        private void GrabPlayer(AIActor enteredPlayer)
        {
           ...
           // base.StartCoroutine(this.HandleGrabbyGrab(enteredPlayer));
            ...
            GameObject gameObject = enteredPlayer.PlayEffectOnActor(hellDrag.HellDragVFX, new Vector3(0f, -0.25f, 0f), true, false, false);    
            tk2dBaseSprite component = gameObject.GetComponent<tk2dBaseSprite>();
            component.UpdateZDepth();
            component.attachParent = null;
            component.IsPerpendicular = false;
            ...
            component.UpdateZDepth();
            //component.transform.position = component.transform.position.WithX(component.transform.position.x + 0.25f);
            //component.transform.position = component.transform.position.WithY(component.transform.position.y + 55f);
            ...
            BotsModule.Log($"{gameObject.transform.position} : {enteredPlayer.transform.position}");
            component.usesOverrideMaterial = true;
            component.renderer.material.shader = ShaderCache.Acquire("Brave/Effects/StencilMasked");
        }
        ...
        private void Grab(AIActor enemy, GameObject HellDragVFX)
        {
            ...
            GameObject gameObject = enemy.PlayEffectOnActor(HellDragVFX.GetComponent<HellDraggerArbitrary>().HellDragVFX, new Vector3(0f, -0.25f, 0f), true, false, false);
            tk2dBaseSprite component = gameObject.GetComponent<tk2dBaseSprite>();
            component.UpdateZDepth();
            component.attachParent = null;
            component.IsPerpendicular = false;
            ...
            BotsModule.Log($"{gameObject.transform.position} : {enemy.transform.position}");
            component.usesOverrideMaterial = true;
            component.renderer.material.shader = ShaderCache.Acquire("Brave/Effects/StencilMasked");
        }
