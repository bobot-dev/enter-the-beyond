...
namespace CustomCharacters
{
    public class CustomCharacterData
    {
        ...
        public string name, nameShort, nickname, nameInternal, color, altGun;
        public Dictionary<PlayerStats.StatType, float> stats;
        public List<Texture2D> sprites, altSprites, foyerCardSprites, punchoutSprites, punchoutFaceCards;
        public Texture2D altPlayerSheet, playerSheet, minimapIcon, bossCard;
