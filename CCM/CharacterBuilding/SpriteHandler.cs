    ...
    public static class SpriteHandler
    {
        ...
        public static void HandleSprites(PlayerController player, CustomCharacterData data)
        {
            ...
            if (data.altSprites != null || data.altPlayerSheet != null)
                HandleAnimations(player, data, true);
        ...
        public static void HandleAnimations(PlayerController player, CustomCharacterData data, bool isAltSkin = false)
        {
            ...
            List<Texture2D> spritesToUse;

            if (isAltSkin)
            {
                spritesToUse = data.altSprites;
            } 
            else
            {
                spritesToUse = data.sprites;
            }
            ...
            if (isAltSkin == true)
            {
                data.AlternateCostumeLibrary = player.spriteAnimator.Library;
            }
