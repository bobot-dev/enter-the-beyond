...
namespace BotsMod
{
    class CustomFire
    {
        public static void Init()
        {
            ...
            blueFire = FakePrefab.Clone((GameObject)UnityEngine.Object.Instantiate(ResourceCache.Acquire("Global VFX/GlobalGreenFireSystem"), Vector3.zero, Quaternion.identity));
            blueFire.GetComponent<ParticleSystemRenderer>().material = new Material(pinkFire.GetComponent<ParticleSystemRenderer>().material);
            blueFire.GetComponent<ParticleSystemRenderer>().material.SetTexture("_MainTex", ResourceExtractor.GetTextureFromResource("BotsMod/sprites/fire_blue_effect_ver1_sheet_11x4.png"));
            blueFire.GetComponent<ParticleSystemRenderer>().material.SetColor("_EmissiveColor", new Color32(227, 73, 155, 255));
        }
