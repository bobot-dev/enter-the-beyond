...
namespace NpcApi
{
    class Examples
    {
        public static void Init()
        {
            ...
            "#EXAMPLE_INTRO", "#EXAMPLE_TAKEPLAYERDAMAGE", ItsDaFuckinShopApi.defaultTalkPointOffset, ItsDaFuckinShopApi.defaultItemPositions, 1, true, new StatModifier[] { new StatModifier { amount = 1, modifyType = StatModifier.ModifyMethod.ADDITIVE, statToBoost = PlayerStats.StatType.Coolness } },
            Examples.ExampleCustomCanBuy, Examples.ExampleCustomRemoveCurrency, Examples.ExampleCustomPrice, null, null, "BotsMod/NpcApi/ExampleSprites/example_currency_icon.png", "examplecurrencytext", true, false, "").GetComponent<CustomShopController>();
        }

        //sets cost based off item quality
        public static int ExampleCustomPrice(CustomShopController shop, CustomShopItemController shopItem, PickupObject item)
        {
