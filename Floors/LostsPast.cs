...
namespace BotsMod
{
    ...
    class LostsPastFlow
    {
        public static DungeonFlow BuildFlow()
        {
            ...
            var bossRoom = RoomFactory.BuildFromResource("BotsMod/rooms/Beyond/LostPastBossRoom2.room");
            
            //bossRoom.

            DungeonFlowNode node = Tools.GenerateFlowNode(flow, PrototypeDungeonRoom.RoomCategory.ENTRANCE, RoomFactory.BuildFromResource("BotsMod/rooms/Beyond/LostPastEntrace.room"));
            DungeonFlowNode node2 = Tools.GenerateFlowNode(flow, PrototypeDungeonRoom.RoomCategory.BOSS, bossRoom);

            //DungeonFlowNode node3 = Tools.GenerateFlowNode(flow, PrototypeDungeonRoom.RoomCategory.EXIT, RoomFactory.BuildFromResource("BotsMod/rooms/Swordtress/SwordtressExit.room"));
            flow.Initialize();
