...
namespace BotsMod
{
	...
	public class BasicBulletLines : Script
	{
		...
		protected override IEnumerator Top() // This is just a simple example, but bullet scripts can do so much more.
		{
			...
			for(int i = 0; i < 3; i++)
            {
				this.Fire(new Direction(-8, DirectionType.Aim, -1f), new Speed(18f, SpeedType.Absolute), new SkellBullet());
				this.Fire(new Direction(0, DirectionType.Aim, -1f), new Speed(18f, SpeedType.Absolute), new SkellBullet());
				this.Fire(new Direction(8, DirectionType.Aim, -1f), new Speed(18f, SpeedType.Absolute), new SkellBullet());
				yield return this.Wait(5);
				this.Fire(new Direction(-8, DirectionType.Aim, -1f), new Speed(18f, SpeedType.Absolute), new SkellBullet());
				this.Fire(new Direction(0, DirectionType.Aim, -1f), new Speed(18f, SpeedType.Absolute), new SkellBullet());
