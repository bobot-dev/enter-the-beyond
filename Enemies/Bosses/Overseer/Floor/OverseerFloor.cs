	...
	class OverseerFloor : AIActor
	{
		...
		public static void BuildPrefab()
		{
			...
			if (OverseerPrefab == null || !BossBuilder.Dictionary.ContainsKey(guid))
			{
				...
				trail.sortingLayerID = actor2.sprite.renderer.sortingLayerID;
				...
				trail2.sortingLayerID = actor2.sprite.renderer.sortingLayerID;
				...
				trail3.sortingLayerID = actor2.sprite.renderer.sortingLayerID;

				ETGModConsole.Log(actor2.sprite.renderer.sortingLayerID +" layer id");
				...
				OverseerPrefab.AddAnimation("death", "BotsMod/sprites/overseer_floor/death", 12, EnemyBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.Single, DirectionalAnimation.FlipType.None).wrapMode = tk2dSpriteAnimationClip.WrapMode.Once;
				...
				OverseerPrefab.AddAnimation("beam_tell", "BotsMod/sprites/overseer_floor/TelBeam", 6, EnemyBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.Single, DirectionalAnimation.FlipType.None).wrapMode = tk2dSpriteAnimationClip.WrapMode.Once;
				...
				OverseerPrefab.AddAnimation("remote_end", "BotsMod/sprites/overseer_floor/remoteEnd", 8, EnemyBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.Single, DirectionalAnimation.FlipType.None).wrapMode = tk2dSpriteAnimationClip.WrapMode.Once;

				//OverseerPrefab.AddAnimation("dash", "BotsMod/sprites/overseer_floor/Dash", 12, EnemyBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.Single, DirectionalAnimation.FlipType.None).wrapMode = tk2dSpriteAnimationClip.WrapMode.Single;

				OverseerPrefab.AddAnimation("overseerf", "dash", "BotsMod/sprites/overseer_floor/Dash", 12, EnemyBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.TwoWayHorizontal, DirectionalAnimation.FlipType.Mirror, tk2dSpriteAnimationClip.WrapMode.Loop);
				OverseerPrefab.AddAnimation("overseerf", "dash_charge", "BotsMod/sprites/overseer_floor/DashCharge", 24, EnemyBuilder.AnimationType.Other, DirectionalAnimation.DirectionType.TwoWayHorizontal, DirectionalAnimation.FlipType.Mirror, tk2dSpriteAnimationClip.WrapMode.Once);
				...
				bs.AttackBehaviorGroup.AttackBehaviors = new List<AttackBehaviorGroup.AttackGroupItem>
				{
					...
					new AttackBehaviorGroup.AttackGroupItem()
					{
						...
						{
							ShootPoint = m_CachedGunAttachPoint,
							BulletScript = new CustomBulletScriptSelector(typeof(BasicBulletLines)),
							LeadAmount = 0.8f,
							AttackCooldown = 1.2f,
							TellAnimation = "",
							FireAnimation = "",
		...
		public class EnemyBehavior : BraveBehaviour
		{
			...
			private void Start()
			{
				...
				foreach(var trail in base.aiActor.gameObject.GetComponents<TrailRenderer>()) { trail.enabled = false; }
