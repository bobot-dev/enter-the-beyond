...
namespace ChallengeAPI
{
    class ChallengeInit
    {
        public static void Init()
        {
            ...
            ChallengeBuilder.BuildChallenge<ExampleChallengeModifier>("BotsMod/sprites/butterChallengeFrame.png", "Butter Fingures", true, null, null, null, true, true);
            ChallengeBuilder.BuildChallenge<FreezeChallengeModifiereModifier>("BotsMod/sprites/butterChallengeFrame.png", "Fuck you ice physics time", true, null, null, null, true, true);
