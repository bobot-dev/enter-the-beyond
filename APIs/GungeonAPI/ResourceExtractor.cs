...
namespace GungeonAPI
{
	...
	public static class ResourceExtractor
	{
		...
		public static List<Texture2D> GetTexturesFromDirectory(string directoryPath)
		{
			...
			if (flag)
			{
				DebugUtility.PrintError<string>(directoryPath + " not found.", "FF0000");
				result = null;
			}
			else
			{
		...
		public static Texture2D GetTextureFromFile(string fileName, string extension = ".png")
		{
			...
			if (flag)
			{
				//DebugUtility.PrintError<string>(text + " not found.", "FF0000");
				result = null;
			}
			else
			{
		...
		public static Texture2D GetTextureFromResource(string resourceName)
		{
			...
			if (flag)
			{
				DebugUtility.PrintError<string>("No bytes found in " + resourceName, "FF0000");
				result = null;
			}
			else
			{
