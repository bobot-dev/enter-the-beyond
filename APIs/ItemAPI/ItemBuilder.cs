...
namespace ItemAPI
{
    public static class ItemBuilder
    {
        ...
        /// blah, blah, blah
        /// </summary>
        public static void SetupItem(this PickupObject item, string shortDesc, string longDesc, string idPool = "customItems", string overrideName = "")
        {
            try
            {
                if(item == null)
                ...
                if (overrideName != "")
                {
                    Gungeon.Game.Items.Add(idPool + ":" + overrideName.ToLower().Replace(" ", "_"), item);
                } 
                else
                {
